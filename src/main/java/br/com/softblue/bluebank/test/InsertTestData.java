...
public class InsertTestData {
    ...
    @Autowired
    public InsertTestData(UsuarioService usuarioService,
	    ExtratoService extratoService, ContaBancariaService contaBancariaService) {
    ...
    private void createUsers(String nome, String email, String cpf, String senha, String numeroPoupanca, String numeroCorrente) {
